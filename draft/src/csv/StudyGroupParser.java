...
public class StudyGroupParser {
     ...
     * @return StudyGroup object
     */
    private StudyGroup studyGroupParser(String id, String name, Coordinates coordinates, ZonedDateTime zonedDateTime, String studentsCount, String expelledStudents, String formOfEducation, String semester, Person person) throws DataParseException {
