...
public abstract class InputManager {
    ...
    public Long readX() throws DataException {
        ...
        if (Float.isInfinite(x) || Float.isNaN(x))
            throw new DataException(ConsoleColor.RED_BACKGROUND + "invalid long value :(" + ConsoleColor.RESET);
        return x;
    }
    ...
    public long readY() throws DataException {
        ...
        if (y > 790)
            throw new DataException(ConsoleColor.RED_BACKGROUND + "must be less than 790 :(" + ConsoleColor.RESET);
        return y;
    }
    ...
    public long readStudentsCount() throws DataException {
        ...
        if (studentCount < 0)
            throw new DataException(ConsoleColor.RED_BACKGROUND + "must be greater than 0 :(" + ConsoleColor.RESET);
        return studentCount;
    }
